...
.method protected loadImageFromCursor(Landroid/database/Cursor;)Lcom/android/camera/gallery/BaseImage;
    ...
    new-instance v0, Lcom/android/camera/gallery/Image;

    iget-object v1, p0, Lcom/android/camera/gallery/ImageList;->mContentResolver:Landroid/content/ContentResolver;

    invoke-virtual {p0, v2, v3}, Lcom/android/camera/gallery/ImageList;->contentUri(J)Landroid/net/Uri;

    move-result-object v4

    invoke-direct/range {v0 .. v9}, Lcom/android/camera/gallery/Image;-><init>(Landroid/content/ContentResolver;JLandroid/net/Uri;JJI)V
